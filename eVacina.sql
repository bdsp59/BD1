...
INSERT INTO CIDADAO VALUES (NULL, "Bruno Proença", "M", 25, "06045842707", "263968182", 6);
INSERT INTO CIDADAO VALUES (NULL, "Julio César", "M", 49, "19856960029", "118485672", 10;
INSERT INTO CIDADAO VALUES (NULL, "Carla Maranhos", "F", 34, "27852441092", "192139058", 8);
INSERT INTO CIDADAO VALUES (NULL, "Maria Pires", "F", 58, "44262987094", "390661818", 7);
INSERT INTO CIDADAO VALUES (NULL, "Felipe Souza", "M", 18, "52997141060", "296278245", 9);
INSERT INTO CIDADAO VALUES (NULL, "Luiz Silva", "M", 56, "79656455720", "419189105", 6);
INSERT INTO CIDADAO VALUES (NULL, "Maria Torres", "F", 22, "49472198074", "134356391", 7);
INSERT INTO CIDADAO VALUES (NULL, "Fernanda Lúcia", "F", 67, "62781723053", "172750799", 9);

#Produtora -> (Código, Nome_Comercial, Nome_Fantasia, CNPJ, FK_ENDERECO)
INSERT INTO PRODUTORA VALUES (NULL, "LABORATORIOS PFIZER LTDA", "Pfizer", "46070868001998", 11);
INSERT INTO PRODUTORA VALUES (NULL, "FUNDACAO OSWALDO CRUZ", "Fiocruz", "33781055000135", 14);
INSERT INTO PRODUTORA VALUES (NULL, "FUNDACAO BUTANTAN", "Butantan", "61189445000156", 12);
INSERT INTO PRODUTORA VALUES (NULL, "GLAXOSMITHKLINE BRASIL LTDA", "GSK", "33247743003569", 13);

#Posto -> (Código, Nome, FK_ENDERECO)
INSERT INTO POSTO VALUES (NULL, "CS Escola Barra Funda", 3);
INSERT INTO POSTO VALUES (NULL, "Centro de Saúde Escola Samuel Barnsley Pessoa", 4);
INSERT INTO POSTO VALUES (NULL, "UBS Ramiro De Azevedo", 5);
INSERT INTO POSTO VALUES (NULL, "Centro Municipal de Saúde José Messias do Carmo", 1);
INSERT INTO POSTO VALUES (NULL, "Cms Oswaldo Cruz", 2);

#Funcionario -> (Código, Cargo, FK_POSTO, FK_CIDADAO)
INSERT INTO FUNCIONARIO VALUES (NULL, "Enfermeira", 2, 3);
INSERT INTO FUNCIONARIO VALUES (NULL, "Segurança", 1, 2);
INSERT INTO FUNCIONARIO VALUES (NULL, "Médica", 3, 7);
INSERT INTO FUNCIONARIO VALUES (NULL, "Enfermeiro", 5, 6);
INSERT INTO FUNCIONARIO VALUES (NULL, "Recepcionista", 4, 8);

#Vacina -> (Código, Nome, Descrição, obrigatoria)
INSERT INTO VACINA VALUES (01011391, "BCG", "APLICAÇÃO DA VACINA BCG DOSE ÚNICA");
INSERT INTO VACINA VALUES (01011588 , "Tríplice Viral", "APLICAÇÃO DA VACINA TRÍPLICE VIRAL (CAXUMBA, RUBÉOLA E SARAMPO) DOSE ÚNICA");
INSERT INTO VACINA VALUES (01011391, "CoronaVac", "APLICAÇÃO DA VACINA CONTRA COVID-19");
INSERT INTO VACINA VALUES (01011391, "BioNTech", "APLICAÇÃO DA VACINA CONTRA COVID-19");
INSERT INTO VACINA VALUES (01011391, "AstraZeneca", "APLICAÇÃO DA VACINA CONTRA COVID-19");


#Lote -> (Código, Data_estoque, FK_POSTO)
INSERT INTO LOTE VALUES ("", "2021-01-19",);
INSERT INTO LOTE VALUES ("", "2021-01-19",);
INSERT INTO LOTE VALUES ("", "2021-01-19",);
INSERT INTO LOTE VALUES ("", "2021-01-19",);
INSERT INTO LOTE VALUES ("", "2021-01-19",);
