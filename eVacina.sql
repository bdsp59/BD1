...
INSERT INTO VACINACAO VALUES(NULL, "2020-03-31", "AXTR65081", 2, 2, 3);
INSERT INTO VACINACAO VALUES(NULL, "2020-05-31", "AXTR65088", 2, 2, 3);
INSERT INTO VACINACAO VALUES(NULL, "2020-06-25", "AXTR65891", 2, 1, 3);
INSERT INTO VACINACAO VALUES(NULL, "2020-08-30", "AXTR65762", 2, 4, 3);
...
BEGIN
    ...
    SELECT Nome AS Vacina_faltantes FROM VACINA WHERE Obrigatoria = true AND Cod_vac NOT IN (SELECT Cod_vac FROM FRASCO WHERE Cod_frasco IN (SELECT Cod_frasco FROM VACINACAO WHERE Cod_cid = @cidadao));
END
$
