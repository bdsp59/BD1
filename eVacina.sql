...
#Tabela Cidadao
ALTER TABLE CIDADAO ADD CONSTRAINT fk_Cidadao_Endereco FOREIGN KEY(Id_Endereco) REFERENCES ENDERECO(IdEndereco);
#Tabela Produtora
ALTER TABLE PRODUTORA ADD CONSTRAINT fk_Produtora_Endereco FOREIGN KEY(Id_Endereco) REFERENCES ENDERECO(IdEndereco);
#Tabela Posto
ALTER TABLE POSTO ADD CONSTRAINT fk_Posto_Endereco FOREIGN KEY(Id_Endereco) REFERENCES ENDERECO(IdEndereco);
#Tabela Funcionario
ALTER TABLE FUNCIONARIO ADD CONSTRAINT fk_Funcionario_Posto FOREIGN KEY(Id_Posto) REFERENCES POSTO(IdPosto);
ALTER TABLE FUNCIONARIO ADD CONSTRAINT fk_Funcionario_Cidadao FOREIGN KEY(Id_Cidadao) REFERENCES CIDADAO(IdCidadao);
#Tabela Lote
ALTER TABLE LOTE ADD CONSTRAINT fk_Lote_Posto FOREIGN KEY(Id_Posto) REFERENCES POSTO(IdPosto);
#Tabela Frasco
ALTER TABLE FRASCO ADD CONSTRAINT fk_Frasco_Lote FOREIGN KEY(Id_Lote) REFERENCES LOTE(IdLote);
ALTER TABLE FRASCO ADD CONSTRAINT fk_Frasco_Vacina FOREIGN KEY(Id_Vacina) REFERENCES VACINA(IdVacina);
#Tabela Contato
ALTER TABLE CONTATO ADD CONSTRAINT fk_Contato_Posto FOREIGN KEY(Id_Posto) REFERENCES POSTO(IdPosto);
ALTER TABLE CONTATO ADD CONSTRAINT fk_Contato_Produtora FOREIGN KEY(Id_Produtora) REFERENCES PRODUTORA(IdProdutora);
ALTER TABLE CONTATO ADD CONSTRAINT fk_Contato_Cidadao FOREIGN KEY(Id_Cidadao) REFERENCES CIDADAO(IdCidadao);
#Tabela Vacina_Produtora
ALTER TABLE VACINA_PRODUTORA ADD CONSTRAINT fk_Vacina_Produtora_Vacina FOREIGN KEY(Id_Vacina) REFERENCES VACINA(IdVacina);
ALTER TABLE VACINA_PRODUTORA ADD CONSTRAINT fk_Vacina_Produtora_Produtora FOREIGN KEY(Id_Produtora) REFERENCES PRODUTORA(IdProdutora);
#Tabela Vacinacao
ALTER TABLE VACINACAO ADD CONSTRAINT fk_Vacinacao_Frasco FOREIGN KEY(Id_Frasco) REFERENCES FRASCO(IdFrasco);
ALTER TABLE VACINACAO ADD CONSTRAINT fk_Vacinacao_Posto FOREIGN KEY(Id_Posto) REFERENCES POSTO(IdPosto);
ALTER TABLE VACINACAO ADD CONSTRAINT fk_Vacinacao_Funcionario FOREIGN KEY(Id_Funcionario) REFERENCES FUNCIONARIO(IdFuncionario);
ALTER TABLE VACINACAO ADD CONSTRAINT fk_Vacinacao_Cidadao FOREIGN KEY(Id_Cidadao) REFERENCES CIDADAO(IdCidadao);